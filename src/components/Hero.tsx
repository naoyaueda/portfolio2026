...
const Hero: React.FC = () => {
  return (
    ...
    <div className="py-32 container mx-auto p-6 lg:flex gap-12 min-h-screen items-center justify-center">
      <div className='space-y-6'>
      <motion.h2 
        initial={{ scale: 0.5, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ delay: 0.3 }}
        className="text-3xl lg:text-4xl font-bold lg:-space-y-4"
      >
        <p><span className='text-accent-amber text-6xl lg:text-9xl uppercase'>Design</span> with</p>
        <p><span className='text-accent-orange text-6xl lg:text-9xl uppercase'>Purpose</span>,</p>
        <p><span className='text-accent-sky text-6xl lg:text-9xl uppercase'>Build</span> with</p>
        <p><span className='text-accent-blue text-6xl lg:text-9xl uppercase'>Clarity</span>.</p>
      </motion.h2>
      <motion.div
