  ...
  const education = [
    {
      ...
      school: "Regent International Education Group",
      place: "Auckland, New Zealand",
      summary: "Most Promising Creative Talent Award recipient. Hands-on training in graphic design, web development, and motion graphics (Adobe After Effects). Contributed poster designs for school events, honing client-focused creative skills foundational to my WordPress/branding career.",
    },
    {
      quolification: "Bachelor of Business Administration",
      school: "Ritsumeikan Asia Pacific University",
      place: "Oita, Japan",
      summary: "International business program at Asia's top multicultural university (50% international students). Built foundation in global management, marketing, and cross-cultural comms—directly fuelling my 15+ year career in student recruitment/web ops.",
    }
  ]
  return (
    <section id="about" className="bg-mono-100 text-mono-900">
      <div className="max-w-7xl mx-auto px-6 py-32">
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className='text-5xl lg:text-7xl uppercase font-bold text-center mb-16'>
            <span className="text-gradient-3d-dark">About</span> <span className='text-accent-orange'>Me</span>
          </h2>
        </motion.div>

        <div className='lg:flex space-y-6 items-center'>
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="relative items-center justify-center text-center">
              ...
              <div>Digital Experience Specialist</div>
              <div className='flex flex-row items-center justify-center gap-2 lg:gap-4 mt-6'>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.2 }}
            className="lg:flex-1 space-y-6 leading-relaxed story-border"
          >
          ...
          {work.map((job, index) => (
            ...
            >
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-4 items-start'>
                <h3 className="text-lg lg:text-xl text-mono-900 font-semibold">
                  {job.title}
                </h3>
                <p className='text-mono-700 lg:text-right'>
                  {job.company}
                </p>
                <p className="text-mono-500">
                  {job.place}
                </p>
                <p className='text-mono-300 lg:text-right'>
                  {job.year}
                </p>
